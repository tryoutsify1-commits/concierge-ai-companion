...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "The Solène · Smart Concierge" },
      { property: "og:description", content: "AI concierge and operations dashboard for a five-star Riviera hotel." },
